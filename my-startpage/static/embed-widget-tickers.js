!function() {
    ...
    var r = function(e, i) {
        var r = this;
        void 0 === i && (i = "json"),
        this.pathname = ("battle" === this._environment() ? "/" : t) + e,
        this.settingsFormat = i,
        this._findScripts().forEach(function(t) {
    ...
    r.prototype._environment = function() {
        ...
        "local");
        return "local" === t && null === location.host.match(/^localhost(:\d+)?$/) && (t = "battle"),
        t
    }
    ,
    ...
    n.iframeSrcBase.get = function() {
        var t = "";
        return "battle" === this._environment() ? t = "https://s.tradingview.com" : "staging" === this._environment() && -1 !== location.hostname.indexOf("beta.tradingview.com") && (t = "https://betacdn.tradingview.com"),
        this.settings.customer && -1 !== this.propertiesToSkipInHash.indexOf("customer") && (t += "/" + this.settings.customer),
        t + this.embedWidgetSitePath
    }
    ,
    ...
    r.prototype._replaceScript = function(t) {
        var e, i, r;
        if (this.script = t,
        "json" === this.settingsFormat ? e = this._scriptContentToJSON() : "stroke" === this.settingsFormat && (e = t.innerHTML.trim()),
        e)
            if (this.settings = this.filterRawSettings(e),
            i = this.settings,
            r = this.utmInfo,
            ...
            this._isValidSettings()) {
                var n, o = isNaN(this.settings.height) ? this.settings.height : this.settings.height + "px", a = isNaN(this.settings.width) ? this.settings.width : this.settings.width + "px";
                this.script.parentNode && this.script.parentNode.classList.contains("tradingview-widget-container") ? this.iframeContainer = this.script.parentNode : this.iframeContainer = document.createElement("div"),
                this.iframeContainer.style.width = a,
                this.iframeContainer.style.height = o,
                this.iframeContainer.appendChild(((n = document.createElement("style")).innerHTML = "\n\t.tradingview-widget-copyright {\n\t\tfont-size: 13px !important;\n\t\tline-height: 32px !important;\n\t\ttext-align: center !important;\n\t\tvertical-align: middle !important;\n\t\tfont-family: 'Trebuchet MS', Tahoma, Arial, sans-serif !important;\n\t\tcolor: #9db2bd !important;\n\t}\n\n\t.tradingview-widget-copyright .blue-text {\n\t\tcolor: #3bb3e4 !important;\n\t}\n\n\t.tradingview-widget-copyright a {\n\t\ttext-decoration: none !important;\n\t\tcolor: #9db2bd !important;\n\t}\n\n\t.tradingview-widget-copyright a:visited {\n\t\tcolor: #9db2bd !important;\n\t}\n\n\t.tradingview-widget-copyright a:hover .blue-text {\n\t\tcolor: #38acdb !important;\n\t}\n\n\t.tradingview-widget-copyright a:active .blue-text {\n\t\tcolor: #299dcd !important;\n\t}\n\n\t.tradingview-widget-copyright a:visited .blue-text {\n\t\tcolor: #3bb3e4 !important;\n\t}\n\t",
                n));
                var s = this._extractOldStyleEmbedCopyrightFromDOM()
                  , c = s && !this.settings.whitelabel
                  , h = this.iframeContainer.querySelector(".tradingview-widget-copyright");
                h && (this.settings.utm_medium = "widget_new");
                var d = s || h ? "calc(" + o + " - 32px)" : o;
                this.iframe = this._createIframe(d, a, t.id);
                var l = this.iframeContainer.querySelector(".tradingview-widget-container__widget");
                if (l ? (this.script.parentNode.replaceChild(this.iframe, l),
                ...
                c) {
                    ...
                    this.iframeContainer.appendChild(p)
                }
            } else
                this._doEmergencyReplacement("Settings is not valid")
    }
    ,
    ...
    r.prototype._scriptContentToJSON = function() {
        ...
        try {
            ...
            return this._doEmergencyReplacement(),
            console.warn("Embed widget settings parse error: ", t),
            null
        }
    }
    ,
    r.prototype._createIframe = function(t, e, i) {
        ...
        i && (r.id = i),
        this.settings.enableScrolling || r.setAttribute("scrolling", "no"),
    ...
    r.prototype._doEmergencyReplacement = function(t) {
        ...
        e.innerHTML = t || "Something gone wrong",
        this.script.parentNode.replaceChild(e, this.script),
        this._extractOldStyleEmbedCopyrightFromDOM()
    }
    ,
    ...
    new (function(t) {
        ...
        e.prototype.filterRawSettings = function(e) {
            ...
            return i.width = "100%",
            i.height = this._calculateHeight(e.whitelabel),
            i
        }
        ,
